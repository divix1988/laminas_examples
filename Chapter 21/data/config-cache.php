 ...
 * at 2020-07-09T00:06:12+02:00
 */
return [
    'config_cache_enabled' => true,
    'config_cache_filemode' => 384,
    'db' => [
        'driver' => 'Pdo',
    ...
    'service_manager' => [
        'factories' => [
            ...
            'Utils\\Security\\Adapter' => function ($sm) {
                return new \Utils\Security\Adapter($sm->get(\Laminas\Db\Adapter\Adapter::class), 'users', 'email', 'password', 'SHA2(CONCAT(password_salt, "' . \Utils\Security\Helper::SALT_KEY . '", ?), 512)');
            },
